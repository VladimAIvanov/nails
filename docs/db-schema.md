...
**Что выбрано.** Четыре статуса, без `no_show`.
...
**Вывод.** Сознательно отложено, потому что на экранах прототипа такого бейджа нет и проставлять статус некому. Как только в панели появится кнопка «не пришла» — вариант 1. Это дополнение набора, а не смена модели: старые записи не пострадают, история в журнале статусов останется целой.
