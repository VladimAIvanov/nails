window.VARVARA_ADMIN = {
  ...
  masters: [
    { id: 'varvara', name: 'Варвара', role: 'Маникюр, наращивание' },
    { id: 'lena', name: 'Лена', role: 'Педикюр, маникюр' },
    { id: 'aya', name: 'Ая', role: 'Дизайн, наращивание' }
  ],
  appointments: [
    { id: 1, master: 'varvara', start: '10:00', min: 90, client: 'Марина К.', service: 'Маникюр с покрытием', price: '3 200 ₽', status: 'confirmed' },
    { id: 2, master: 'varvara', start: '12:00', min: 180, client: 'Ольга П.', service: 'Наращивание', price: '5 500 ₽', status: 'confirmed' },
    { id: 3, master: 'varvara', start: '18:00', min: 90, client: 'Марина К.', service: 'Маникюр с покрытием', price: '3 200 ₽', status: 'pending' },
  ...
  rows: [
    { id: 1042, when: '15 авг · 18:00', client: 'Марина К.', phone: '+7 921 000-00-00', service: 'Маникюр с покрытием', master: 'Варвара', price: '3 200 ₽', status: 'pending', source: 'Telegram' },
    ...
    { id: 1038, when: '15 авг · 12:00', client: 'Ольга П.', phone: '+7 905 444-44-44', service: 'Наращивание', master: 'Варвара', price: '5 500 ₽', status: 'confirmed', source: 'Telegram' },
    { id: 1037, when: '14 авг · 19:30', client: 'Даша И.', phone: '+7 906 555-55-55', service: 'Маникюр с покрытием', master: 'Варвара', price: '3 200 ₽', status: 'done', source: 'Telegram' }
  ]
};
