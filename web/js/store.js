...
const empty = () => ({
  ...
  rescheduleId: null,
  /* Что сервер ответил на создание записи. Нужно только гостю: перезапросить
     визит по номеру он не может — своим сервер его не считает, а чужие
     записи не отдаёт. Это не «данные с прошлого экрана», а ответ сервера
     о том, что действительно сохранено. */
  done: null
});
